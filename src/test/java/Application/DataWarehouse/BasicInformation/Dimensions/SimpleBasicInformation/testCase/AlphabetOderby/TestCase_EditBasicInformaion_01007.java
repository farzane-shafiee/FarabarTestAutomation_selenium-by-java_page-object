...
public class TestCase_EditBasicInformaion_01007 {
	WebDriver driver;
	...
	public void f() throws IOException, InterruptedException {
		...
		SimpleBasicInformationPage editBasicInformation = new SimpleBasicInformationPage(driver);
		editBasicInformation.EditBasicInformation(editTitle);
		
		//Assertion Edit Alphabet Order by
		int count_AfterAction = simpleBasicInformationPage.AssertionCreateBasicInformation();
		Assert.assertEquals(count_AfterAction, 1);
		Thread.sleep(1000);
		Assert.assertEquals(simpleBasicInformationPage.AssertionNewChild(editTitle), editTitle);
	}
