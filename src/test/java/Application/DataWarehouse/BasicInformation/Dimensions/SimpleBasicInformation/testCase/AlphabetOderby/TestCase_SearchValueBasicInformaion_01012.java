...
public class TestCase_SearchValueBasicInformaion_01012 {
	WebDriver driver;
	...
	public void f() throws IOException, InterruptedException {
		...
		//Search value
		  SimpleBasicInformationPage searchValueBasicInformation = new SimpleBasicInformationPage(driver);
		  searchValueBasicInformation.SearchValueBasicInformation(searchTitle);
	}
