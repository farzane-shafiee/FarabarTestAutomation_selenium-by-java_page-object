...
public class TestCase_EditValueBasicInformaion_01009 {
	WebDriver driver;
	...
	public void f() throws IOException, InterruptedException {
		...
		String valueName = "مقدار ویرایش شده";
		...
		//Edit value  
		  SimpleBasicInformationPage editValueBasicInformation = new SimpleBasicInformationPage(driver);
		  editValueBasicInformation.EditValueBasicInformation(valueName);
	}
