...
public class TestCase_ManagementReportValueBasicInformaion_01010 {
	WebDriver driver;
	...
	public void f() throws IOException, InterruptedException {
		...
		//Management Report value
		  SimpleBasicInformationPage managementReportValueBasicInformation = new SimpleBasicInformationPage(driver);
		  managementReportValueBasicInformation.ManagementReportValueBasicInformation();
	}
