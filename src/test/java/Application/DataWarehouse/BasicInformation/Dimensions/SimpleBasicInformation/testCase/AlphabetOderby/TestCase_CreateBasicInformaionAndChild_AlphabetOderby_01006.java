...
public class TestCase_CreateBasicInformaionAndChild_AlphabetOderby_01006 {
	WebDriver driver;
	...
	public void f() throws IOException, InterruptedException {
		...
		Assert.assertEquals(count_AfterAction, 3);
		Thread.sleep(1000);
		Assert.assertEquals(simpleBasicInformationPage.AssertionNewChild(UDTyear), UDTyear);
		Assert.assertEquals(simpleBasicInformationPage.AssertionNewChild(UDTmonth), UDTmonth);
		Assert.assertEquals(simpleBasicInformationPage.AssertionNewChild(UDTday), UDTday);
	}
